...
export class MlService {
    ...
    async batchAnalyze(files: Express.Multer.File[], jobDescription: string): Promise<BatchAnalysisResult> {
        try {
            ...
            this.logger.log(`Batch analysis complete: ${response.data.successful}/${response.data.total} successful`);
            return response.data;
        } catch (error) {
