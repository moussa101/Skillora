    ...
    return (
        <div className="min-h-screen bg-[var(--background)] flex flex-col">
            ...
            <nav className="w-full py-4 px-6 flex justify-between items-center">
                ...
                <Link href="/login" className="text-[var(--accent)] text-sm font-medium hover:underline">
                    Sign in
                </Link>
            </nav>
            ...
            <main className="flex-1 flex items-center justify-center px-6">
                <div className="w-full max-w-md">
                    <div className="text-center mb-8">
                        <h1 className="text-3xl font-semibold text-[var(--foreground)] mb-2">Create your account</h1>
                        <p className="text-[var(--gray-500)]">Start analyzing resumes with AI</p>
                    </div>
                    ...
                    <div className="space-y-3 mb-6">
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-[#333] border border-[#444] text-white rounded-xl font-medium hover:bg-[#444] transition-colors"
                        >
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                minLength={8}
                            />
                            <p className="mt-1 text-xs text-[var(--gray-400)]">Minimum 8 characters</p>
                        </div>
