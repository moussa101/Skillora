...
function AnimatedGreeting() {
  ...
  return (
    <div className="h-48 flex items-center justify-center py-4">
      <span
        className={`text-8xl md:text-9xl font-bold bg-gradient-to-r from-[#2997ff] to-[#5856d6] bg-clip-text text-transparent transition-all duration-500 ease-out leading-tight ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-4"
          }`}
      >
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 text-center">
        ...
        <p className="mt-4 text-base text-[var(--gray-500)] max-w-xl leading-relaxed">
        ...
        {/* Features Grid */}
        <div className="mt-10 flex flex-col md:flex-row items-center justify-center gap-6 w-full max-w-3xl">
          <div className="card-glass p-5 rounded-xl text-center flex-1 max-w-[220px]">
